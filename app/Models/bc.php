...
class Workshop extends Authenticatable
{
    ...
    public function getIsPremiumAttribute()
    {
        ...
        // OPSIONAL: Cek whitelist nama plan (jika Anda punya paket 'Trial Premium' yang harganya 0)
        // $premiumKeywords = ['Pro', 'Premium', 'Gold', 'Trial'];
        // foreach ($premiumKeywords as $keyword) {
        //     if (stripos($sub->plan->plan_name, $keyword) !== false) {
        //         return true;
        //     }
        // }
